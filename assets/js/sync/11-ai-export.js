...
function genExport(){
  ...
  const trackingPreferencesBlock=p950BuildTrackingPreferencesExport(dkeys.length?dkeys[0].slice(4):null,dkeys.length?dkeys[dkeys.length-1].slice(4):null);
...
function mf105BuildResponseContract(){
  return "=== AI RESPONSE / MUTATION CONTRACT ===\n\nFirst provide concise prose using these headings: COACHING ASSESSMENT, CHANGES, and WHAT I INTENTIONALLY LEFT ALONE. Review cross-domain conflicts, redundancies, synergies, adherence, and existing experiments. Do not manufacture changes; no change is acceptable. MarcusFit parses only the marked JSON block.\n\nLIFTING EVIDENCE INTERPRETATION\n- Per-Set Detailed evidence contains actual individual-set weight, reps, and RIR observations.\n- Per-Lift Simple evidence is one conservative exercise-level summary: reps means the lowest-rep counted work set, and RIR means the hardest/lowest-RIR counted work set.\n- Never infer, expand, or fabricate individual set values from a Per-Lift summary. Weigh Simple evidence as less granular while still using a qualifying summary for normal direct progression.\n\n"
    ...
    +"HABIT PROPOSAL\n{\"habitProposal\":{\"schemaVersion\":1,\"proposalVersion\":\"10.5.0\",\"proposalId\":\"habit-proposal-example\",\"summary\":\"Small sustainable adjustment\",\"rationale\":\"Adherence evidence supports simplification.\",\"changes\":[{\"action\":\"modify\",\"habitId\":\"exact-habit-id\",\"fields\":{\"schedule\":{\"type\":\"daily\"}},\"rationale\":\"Reason\"}]}}\nActions: keep, add, modify, archive, reactivate, reorder. New IDs begin habit-. Modify only name, icon, description, target, schedule, instructions, emphasis. Add requires habitId plus definition with id, name, target, and schedule. Reorder uses a complete order array. Preferred icon values: check-circle, bolt, water, brain, dumbbell, activity, moon, target, fire; do not send emoji. Legacy or unknown icon strings remain compatible. Do not convert medication schedules into Habits.\n\n"
