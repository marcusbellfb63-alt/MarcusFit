...
const MF_BASKETBALL_PRESCRIPTIONS = mfBasketballDeepFreeze({
  ...
  guard_weak_hand_control:mfBasketballPrescription("Use only the weak hand through pounds, in-out dribbles, retreats, and two-dribble attacks.","4 rounds of 75 sec with 30 sec rest.",["Ball outside the knee","Accelerate after the rhythm change"],"No more than 2 lost balls in any round.","Set two cones 10–15 feet apart with one ball.","Perform one pattern per round, traveling between cones and resetting under control.","Stay stationary for pounds and in-outs.","Add a live finish after every attack.","Builds guard-level weak-hand control under movement."),
  guard_crossover_change_direction:mfBasketballPrescription("Attack a cone, plant outside the frame, cross low, and accelerate for two dribbles.","4 rounds of 90 sec with 30 sec rest; alternate hands.",["Sell the first direction","Win the next two dribbles"],"Complete 8 clean changes per round with 2 or fewer fumbles.","Place one cone 10–15 feet away and leave an exit lane on both sides.","Approach under control, cross at the cone, burst past its hip, decelerate, and return from the other side.","Walk the approach and pause after the crossover.","Add a retreat setup or finish at the rim.","Trains a crossover that actually creates separation."),
  guard_behind_back_foundation:mfBasketballPrescription("Approach a cone, transfer behind the hips, and escape for two strong dribbles.","4 rounds of 90 sec with 30 sec rest.",["Ball travels behind the hips, not the back","Push off the outside foot"],"Complete 6 clean reps each direction per round.","Use one cone and a clear 15-foot lane.","Start slow, wrap behind at the cone, catch outside the far hip, and accelerate away.","Practice stationary transfers with a lateral step.","Add a retreat dribble before the move and a finish after it.","Turns the wrap into a protected direction change."),
  ...
  guard_between_legs:mfBasketballPrescription("Drive toward a cone, transfer between the legs, and burst into the new lane.","4 rounds of 90 sec with 30 sec rest; alternate lead leg.",["Step long before the transfer","Catch the ball outside the hip"],"Complete 8 clean transfers per round with no upright pauses.","Place a cone 12 feet away with open space to both sides.","Approach, split the stance, transfer under the lead leg, and take two explosive escape dribbles.","Practice stationary transfers with a wide stance.","Add between-the-legs into crossover or a pull-up.","Builds a protected change-of-direction option."),
  guard_hesitation:mfBasketballPrescription("Attack at medium pace, rise into a hesitation, then explode past the cone.","4 rounds of 75 sec with 30 sec rest.",["Change body height, not just hand speed","First attack dribble reaches past the cone"],"Complete 6 convincing hesitations each hand per round.","Set one cone as a defender and use a 15-foot attack lane.","Approach, briefly lift the eyes and torso, keep the dribble alive, then accelerate for two dribbles.","Use one hand only and walk through the speed change.","Add a crossover after the hesitation or finish at the rim.","Develops pace control to move a defender without contact."),
...
function mfBasketballPrescriptionFor(drill){return drill&&(drill.prescription||MF_BASKETBALL_PRESCRIPTIONS[drill.id])||null;}
