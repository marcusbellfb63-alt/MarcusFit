...
10.7.0 is the new implementation candidate and is not accepted. It is pending automated validation plus Marcus's local-browser and real-iPhone manual QA.
