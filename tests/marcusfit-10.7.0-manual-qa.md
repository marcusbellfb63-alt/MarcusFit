...
- Scroll each tab down, leave it, and confirm every tap, keyboard selection, and successful swipe into Program, Daily Log, History, Stats, or Sync opens at the top rather than restoring a prior offset.
...
- On real iPhone Safari and home-screen mode, confirm reps/count opens an integer keypad and weight/load opens a decimal-capable keypad.
...
Real iPhone Safari remains the final safe-area, browser-edge gesture, zoom/text-size, virtual-keyboard, overlay, and home-screen acceptance gate.
