...
assert(constants.includes('const APP_VERSION = "10.9.0";'), "10.5 cross-domain contract must survive later version increments");
assert(constants.includes("const LIFECYCLE_VERSION = APP_VERSION;"));
assert(html.includes("<title>MarcusFit 10.9.0</title>"));
...
assert.deepStrictEqual(metrics, { characters: sizeFixture.after10_9.characters, lines: sizeFixture.after10_9.lines });
