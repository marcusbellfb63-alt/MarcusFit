...
assert(constants.includes('const APP_VERSION = "10.11.1";'), "10.5 cross-domain contract must survive later version increments");
assert(constants.includes("const LIFECYCLE_VERSION = APP_VERSION;"));
assert(html.includes("<title>MarcusFit 10.11.1</title>"));
