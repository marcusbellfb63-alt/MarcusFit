...
Complete and note a scheduled Habit, inspect a non-due/weekly-count case, and inspect recurring medication status. Confirm historical Habit completion is unchanged by proposal operations, medication is not converted to a Habit, History/Stats remain readable, and no console errors appear.
