...
assert(index.includes("<title>MarcusFit 10.12.0</title>"));
assert(fs.readFileSync(path.join(root, "assets/js/core/01-app-constants.js"), "utf8").includes('APP_VERSION = "10.12.0"'), "10.4 Habit Sync contract must survive later version increments");
