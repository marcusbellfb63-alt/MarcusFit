...
assert(index.includes("<title>MarcusFit 10.11.1</title>"));
assert(fs.readFileSync(path.join(root, "assets/js/core/01-app-constants.js"), "utf8").includes('APP_VERSION = "10.11.1"'), "10.4 Habit Sync contract must survive later version increments");
